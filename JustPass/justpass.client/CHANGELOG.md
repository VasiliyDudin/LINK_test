...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest justpass.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`justpass.client.esproj`).
